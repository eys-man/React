...
import monkey from '../assets/monkey_1.jpg';
import pugna from '../assets/pugna.jpg';
import slardar from '../assets/slardar.jpg';
...
const items = [
  ...
  },
  {
    ...
    image: monkey,
    title: 'Monkey King',
    description: `Always in search of a good fight, Monkey King Dances and travels atop of trees aiming to Spring from leafy cover and surprise his enemies. A tuft of hair—plucked from his head—scatters into the wind, calling and commanding upon an army of Monkey Soldiers to overwhelm opponents, this agile Trickster revels in the chaos of battle, ready to show is Mastery over his arts, slamming his legendary Boundless Staff down on any hopes of escape.`,
  },
  {
    id: 3,
    image: pugna,
    title: 'Pugna',
    description: `A crafty trickster, Pugna turns the enemy's power against itself as he Blasts their defenses. While his Nether Ward strikes nearby foes that dare to cast a spell. He Decrepifies his target, temporary banishing them to another realm, and Drains Life from his enemies while replenishing himself with their vitality, ensuring that he will be ready for the next assault.`,
  },
  {
    id: 4,
    image: slardar,
    title: `Slardar, the Slithereen Guard`,
    description: `Slardar is a Slithereen, one of the Deep Ones, guardian of a vast network of sunken cities and the ancient riches buried within them. In the lightless gulf of the deepest ocean abysses, the Slithereen Guard patrols secret treasure rooms, ever vigilant against the subaqueous thieves sent into the deeps by covetous dryland sorcerers. He is utterly loyal, and his taciturn nature hides deep knowledge of the most secret places of the sea. He rises to the shallows in spite of the pain caused him by brightness, to commit reconnaissance, to make sure no one is conspiring against the depths, and sometimes in relentless pursuit of the rare few who manage to steal off with an item from the Sunken Treasury. Because he has spent his whole life at great pressure, under tremendous weight of the sea, Slardar the Slithereen Guard is a creature of immense power`,
  },
  {
    id: 5,
    image: tidehunter,
    title: `Leviathan, the Tidehunter`,
    description: `The Tidehunter known as Leviathan was once the champion of the Sunken Isles, but his motives are as mysterious as those of his people. We all know the importance of the Drylanders' shipping lanes, how empires may rise and fall according to who controls the open water. Far less is known of the submarine lanes, and how the warring tribes of the Meranthic Diaspora have carved out habitations through endless undersea skirmishes. In the fragile treaties between the Mer and Men, we can glimpse the extent of the drowned empires, but their politics appear complex and opaque. It would seem that Leviathan tired of such petty strife, and set off on his own, loyal only to his abyssal god, Maelrawn the Tentacular. He stalks the shallows now in search of men or meranths who stray into his path, and with a particular loathing for Admiral Kunkka, who has long been his nemesis for reasons lost in the deepest trenches of the sea.`,
  },
  {
    id: 6,
    image: wisp,
    title: `Io, the Wisp`,
    description: `Io is everywhere, and in all things. Denounced by enemies as the great unmaker, worshiped by scholars as the twinkling of a divine eye, this strange Wisp of life-force occupies all planes at once, the merest fraction of its being crossing into physical existence at any one moment.
